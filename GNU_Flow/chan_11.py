...
class chan_11(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "chan_11")
        ...
        self.rational_resampler_xxx_0_0_0_3 = filter.rational_resampler_ccc(
                ...
                taps=[],
                fractional_bw=0)
        self.rational_resampler_xxx_0_0_0_2 = filter.rational_resampler_ccc(
                interpolation=1,
                decimation=dec_factor,
                taps=[],
                fractional_bw=0)
        ...
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_gr_complex, 1, '127.0.0.1', 2000, 0, 32768, False)
        ...
        self.iir_filter_xxx_0 = filter.iir_filter_ccd(FFtaps, FBtaps, False)
        self.blocks_rotator_cc_0_0_1 = blocks.rotator_cc((3 * M_PI) / 5, False)
        self.blocks_rotator_cc_0_0_0_1_0 = blocks.rotator_cc((-3 * M_PI) / 5, False)
        self.blocks_rotator_cc_0_0_0_0 = blocks.rotator_cc((-2 * M_PI) / 5, False)
        self.blocks_rotator_cc_0_0_0 = blocks.rotator_cc((2 * M_PI) / 5, False)
        self.blocks_rotator_cc_0_0 = blocks.rotator_cc((1 * M_PI) / 5, False)
        self.blocks_rotator_cc_0 = blocks.rotator_cc((-1 * M_PI) / 5, False)
        ...
        self.connect((self.iir_filter_xxx_0, 0), (self.rational_resampler_xxx_0_0_0_2, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0_2, 0), (self.network_udp_sink_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.iir_filter_xxx_0, 0))
    ...
    def set_M_PI(self, M_PI):
        self.M_PI = M_PI
        self.blocks_rotator_cc_0.set_phase_inc((-1 * self.M_PI) / 5)
        self.blocks_rotator_cc_0_0.set_phase_inc((1 * self.M_PI) / 5)
        self.blocks_rotator_cc_0_0_0.set_phase_inc((2 * self.M_PI) / 5)
        self.blocks_rotator_cc_0_0_0_0.set_phase_inc((-2 * self.M_PI) / 5)
        self.blocks_rotator_cc_0_0_0_1_0.set_phase_inc((-3 * self.M_PI) / 5)
        self.blocks_rotator_cc_0_0_1.set_phase_inc((3 * self.M_PI) / 5)
    ...
    def set_FFtaps(self, FFtaps):
        self.FFtaps = FFtaps
        self.iir_filter_xxx_0.set_taps(self.FFtaps, self.FBtaps)
...
def main(top_block_cls=chan_11, options=None):
