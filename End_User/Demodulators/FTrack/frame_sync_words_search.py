...
# sync_edge_idx > 0 indicates valid sync words have been found
    ...
    SYNC_WORD_OFFSET = FRM_SYNC_WORD_FREQ
    OFFSET_TOLERANCE = TRK_CLUSTER_FREQ_TOLERANCE
    
    PREAMB_CHIRP_NUM_MIN = TRK_PREAMBLE_MIN
    PREAMB_CHIRP_NUM_MAX = TRK_PREAMBLE_MAX
...
def track_edge_relation(track, edge, chirp_len):
    ...
    SYNC_SCALE_FACTOR = SYNC_TRK_LEN_SCALE_FACTOR
