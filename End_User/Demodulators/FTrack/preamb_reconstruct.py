from .config import *
from .chirp_template import chirp_template
from .sliding_fft_v2 import sliding_fft_v2
...
def preamb_reconstruct(signals, chirp_len, nfft, reserve_bin, init_offset):
    ...
    SEARCH_RANGE = (EDGE_SEARCH_RANGE)*chirp_len
    ...
    coef_threshold = EDGE_CORRELATION_THRESHOLD
    coef_diff_min = 0.05
