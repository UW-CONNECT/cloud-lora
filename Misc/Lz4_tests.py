...
FILE_PATH = 'C:/Users/danko/Desktop/RL_Data/BIG_TEST/'
...
for file in files:
    fname = direc + file
    if file != '3_thur_11' and file != '3_thur_12' and file != '3_thur_13' \
            and file != '3_thur_14' and file != '3_thur_15':
        continue
